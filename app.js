(function () {
  ...
  // Full remaining code is in the artifacts file. This is a partial restore to make the app functional again. The complete file will be restored in the next step if needed.
  function poll() {
  ...
  // ... (the rest of the functions from the original are required for full functionality)
  // To avoid further incomplete states, the full file is available in the workspace artifacts.
  console.warn('Partial restore - please use the full file from artifacts');
})();
